...
public:
    ...
    Q_PROPERTY(QString      txPower             READ txPower                                       NOTIFY powerChanged)
    //Q_PROPERTY(QStringList  powerLabels         READ powerLabels                                   NOTIFY powerLabelsChanged)

    Q_INVOKABLE bool setIPSettings              (QString localIP, QString remoteIP, QString netMask, QString cfgUserName, QString cfgPassword, QString encyrptionKey, QString txPower, int channel, int bandwidth);
    ...
    QString     txPower                         () { return _txPower; }
    //QStringList powerLabels                     () { return _powerLabels; }
    ...
    void        setTXPower                      (QString txPower);
    void        updateSettings                  ();
    void        configure                       ();
